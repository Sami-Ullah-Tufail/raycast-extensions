...
2. Get your API key from [app.cognimemo.com](https://app.cognimemo.com)
...
This extension requires a CogniMemo API key. You can get your API key from the [Integrations page](https://app.cognimemo.com/integrations) in your CogniMemo account.
